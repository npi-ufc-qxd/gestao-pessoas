				       ...
				       <tbody class="panel">
							<c:forEach var="folga" items="${periodo.folgas}">
								<tr class="linha">
									...
									<td align="right">
										<a href="<c:url value="/supervisor/periodo/${periodo.id}/folga/${folga.id}/editar" />" title="Editar" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>
									</td>
								</tr>
							</c:forEach>
				       </tbody>
