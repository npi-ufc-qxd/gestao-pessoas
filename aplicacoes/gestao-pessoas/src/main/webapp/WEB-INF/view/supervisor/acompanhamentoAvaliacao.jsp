...
<div class="container">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h2 class="titulo-panels"><span class="fa fa-folder-open"></span> Acompanhamento de Avaliação </h2>
		...
		<div class="panel-body">
			...
			<c:if test="${empty estagiario}"><div class="alert alert-warning" role="alert">Estagiário inexistente.</div></c:if>

			<c:if test="${not empty estagiario}">
				<div class="form-group">
					<label class="col-sm-1 text-view-info"><strong>Nome do Estagiário: </strong></label><label class="col-sm-11 text-view-info">${estagiario.nomeCompleto}</label>
				</div>

				<div class="form-group">
					<label class="col-sm-1 text-view-info"><strong>Semestre: </strong></label><label class="col-sm-3 text-view-info">${estagiario.semestre}</label>

					<label class="col-sm-1 text-view-info"><strong>Curso: </strong></label><label class="col-sm-3 text-view-info">${estagiario.curso}</label>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h2 class="titulo-panels"><span class="fa fa-television"></span> Seminário</h2>
		...
		<div class="panel-body">
			<c:if test="${empty turma.horarios}"><div class="alert alert-warning" role="alert">Expediente não definido.</div></c:if>
			       ...
			       <tbody class="text-view-info">
						<c:forEach var="estagiario" items="${turma.estagiarios}">
							<tr>
								...
								<td>xx%</td>
								<td align="right">
									<a href="<c:url value="/supervisor/turma/${idTurma }/estagiario/${estagiario.id}/frequencia" />" title="Acompanhamento de Avaliação" class="btn btn-info btn-sm">Acompanhamento de Avaliação</a>
								</td>
								<td align="right">
