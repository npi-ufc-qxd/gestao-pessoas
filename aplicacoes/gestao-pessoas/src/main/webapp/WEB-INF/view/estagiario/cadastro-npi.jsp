...
<div id="inicioEstagiarioNPI"
	class="flippant-back flippant-modal-dark flipper flipped"
	style="position: fixed; min-height: 136px; z-index: 9999;">

	<div class="container fuelux" style="color: #333;">
		<h2>
			<a class="header-anchor" href="#"><span
				class="glyphicon glyphicon-link"></span></a>Meu cadastro no NPI
		</h2>
		<div class="section">
			<div class="wizard" data-initialize="wizard" id="cadastroNPIWizard">
				<ul class="steps">
					<li data-step="1" class="active"><span
						class="badge badge-info">1</span>Dados Pessoais<span
						class="chevron"></span></li>
					<li data-step="2"><span class="badge">2</span>Contas<span
						class="chevron"></span></li>
					<li data-step="3"><span class="badge">3</span>Turma<span
						class="chevron"></span></li>
				</ul>

				<div class="actions">
					<button class="btn btn-default btn-prev" disabled="disabled">
						<span class="glyphicon glyphicon-arrow-left"></span>Anterior
					</button>
					<button class="btn btn-default btn-next" data-last="Finalizar">
						Próximo<span class="glyphicon glyphicon-arrow-right"></span>
					</button>
				</div>

				<form:form id="meuCadastroNPIEstagiario" role="form"
					...
					<div class="step-content">
						<div class="step-pane alert active" data-step="1"
							...
							<div class="form-group">
								...
								<div class="form-item">
									<label for="dataNascimento" class="col-sm-2 control-label">Data
										nascimento:</label>
									<div class="col-sm-3">
										<form:input id="dataNascimento" type="text"
											path="dataNascimento" cssClass="form-control data"
											placeholder="Data Nascimento" style="z-index: 9999" />
										<div class="error-validation">
							...
							<div class="form-group">
								<div class="form-item">
									<label for="nomeMae" class="col-sm-2 control-label">Nome
										da Mãe:</label>
									<div class="col-sm-10">
										<form:input id="nomeMae" path="nomeMae"
											cssClass="form-control" placeholder="Nome Mãe" />
									</div>
								</div>
							</div>
								...
								<div class="form-item">
									...
									<div class="col-sm-2">
										<form:input id="semestre" type="text" path="semestre"
											cssClass="form-control data" placeholder="semestre" size="40" />
									</div>
								</div>

								<div class="form-item">
									<label for="curso" class="col-sm-1 control-label">Curso
										:</label>
									<div class="col-sm-3">
										<form:select path="curso" cssClass="selectpicker"
											data-width="auto">
								...
								<div class="form-item">
									...
									<div class="col-sm-10">
										<form:input id="endereco" path="endereco"
											cssClass="form-control" placeholder="Endereço" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="form-item">
									<label for="cidade" class="col-sm-2 control-label">Cidade
										:</label>
									<div class="col-sm-2">
								...
								<div class="form-item">
									...
									<div class="col-sm-4">
										<form:input id="telefone" path="telefone"
											cssClass="form-control" placeholder="Telefone" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="step-pane alert" data-step="2" id="conta">
							<!-- INICIO PASSO 2 -->
							<div class="form-group">
								<div class="form-group">
									<div class="form-item">
						...
						<div class="step-pane alert" data-step="3" id="turma">
							<!-- INICIO PASSO 3 -->
							<form:radiobuttons path="turma.id" items="${turmas }"
								itemLabel="codigo" itemValue="id" />
						</div>
					</div>
					<!-- FINAL PASSO 3 -->
				</form:form>
