				...
				<form:form id="adicionarProjetoForm" role="form"
					...
					<div class="form-group">
						...
						<label for="dataNascimento" class="col-sm-2 control-label">Data
							nascimento:</label>
						<div class="col-sm-10">
							<form:input id="dataNascimento" path="dataNascimento"
								cssClass="form-control"
						...
						<label for="cep" class="col-sm-2 control-label">CEP
							:</label>
						<div class="col-sm-10">
							<form:input id="cep" path="cep"
								cssClass="form-control"
								placeholder="CEP" />
						</div>
						...
						<label for="cidade" class="col-sm-2 control-label">Cidade
							:</label>
						<div class="col-sm-10">
							<form:input id="cidade" path="cidade"
								cssClass="form-control"
								placeholder="Cidade" />
						</div>
						
						<label for="uf" class="col-sm-2 control-label">UF
							:</label>
						<div class="col-sm-10">
							<form:input id="uf" path="uf"
								cssClass="form-control"
								placeholder="UF" />
						</div>
						...
						<label for="curso" class="col-sm-2 control-label">Curso
							:</label>
						<div class="col-sm-10">
							<form:input id="curso" path="curso"
								cssClass="form-control"
								placeholder="Curso" />
						</div>
