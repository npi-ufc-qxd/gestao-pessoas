...
//		model.addAttribute("format", "pdf");
	...
	public String listarFrequenciaTurma(@PathVariable("idTurma") Long idTurma, @PathVariable("data") String data, Model model, HttpSession session) {
//		Pessoa pessoa = getUsuarioLogado(session);
...
//		model.addAttribute("estagiario", estagiarioService.find(Estagiario.class, idEstagiario));
	...
	public String editarAvaliacaoRendimento(Model model, @Valid @ModelAttribute("avaliacaoRendimento") AvaliacaoRendimento avaliacaoRendimento,
			RedirectAttributes redirect, @PathVariable("idEstagio") Long idEstagio) {
